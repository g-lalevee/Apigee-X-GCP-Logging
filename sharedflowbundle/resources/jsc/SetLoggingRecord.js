...
var organization = context.getVariable("organization.name") || "none";
var environment = context.getVariable("environment.name")|| "none";
var region = context.getVariable("system.region.name") || "none";
var apiProxy = context.getVariable("apiproxy.name")|| "none";
...
var target_host = context.getVariable("target.host");
...
var targetResponseReceived = context.getVariable("target.received.end.timestamp");
var targetRequestSent = context.getVariable("target.sent.end.timestamp");
var targetResponseCode = context.getVariable("message.status.code");
var proxyResponseCode = context.getVariable("response.status.code");
